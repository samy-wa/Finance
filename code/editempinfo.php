...
<body>
    <?php
			...
			{		
				?>
    <form id="form1" name="abc" method="post" action="editempinfoaction.php" onSubmit="return validateForm1()">
        <div class="container">
            ...
            <div class="form-group mb-3">
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="Sex" placeholder="Gender"
                        required>
                        <option value="">--Select--</option>
                        <option value="male">male</option>
                        <option value="female">female</option>
                    </select>
                    <name="Sex" value="<?php $row['Sex'];?>" onKeyPress="return ValidateAlpha(event)">
                </div>
            </div>
            <div class="form-group mb-3">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Proffession</label>
                    <input class="form-control" type="text" name="proffession" value="<?php echo $row['proffession'];?>"
                        onKeyPress="return ValidateAlpha(event)">
                </div>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Aualification</label>
                    <input class="form-control" type="text" name="qualification"
                        value="<?php echo $row['qualification'];?>" onKeyPress="return ValidateAlpha(event)">
                </div>
            </div>
            <div class="form-group mb-3">
                <div class="mb-3">
...
<body bgcolor="orange">
    ...
    <form id="form1" name="abc" method="post" action="editempinfoaction.php" onSubmit="return validateForm1()">
        ...
        <div style="float:left;"><strong>Update Employee information</strong></div>
        <div
...
//include('allmembers.php');
 ...
 echo '<form action="editaccount-exec.php" method="post" name="abc" onsubmit="return validateForm1()">';
	//echo "<img width=200 height=180 alt='Unable to View' src='" . $row1["image"] . "'>"
			...
			while($row = mysqli_fetch_array($result))
  			{
			echo '<br> <strong>Account Id:</strong>'.'<input type="text" name="id" value="'. $row['id'] .'" onKeyPress="return isNumberKey(event)">'; 
			echo '<br>';
			...
			echo '<br>';
  			echo '<br> <strong>Last Name:</strong> '.'<input type="text" name="lname" value="'. $row['lname'] .'" onKeyPress="return ValidateAlpha(event)">'; 
			   echo '<br>';
			  echo '<br> <strong>Employee Sex: <select size="1" name="Sex"   placeholder = "Sex" required>
                 <option value="" selected="selected">--Select--</option>
                 <option value="male">male</option>
                    <option value="female">female</option>
                 </select>

			  '.'<name="Sex" value="'. $row['Sex'] .'" onKeyPress="return ValidateAlpha(event)">';
			   echo '<br>';
			   echo '<br> <strong>proffession :</strong> '.'<input type="text" name="proffession" value="'. $row['proffession'] .'" onKeyPress="return ValidateAlpha(event)">'; 
			   echo '<br>';
			  echo '<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Phone : </strong>'.'<input type="text" name="phone" value="'. $row['phone'] .'">';
			   echo '<br>';
			   echo '<br> <strong>E_mail Adress: '.'<input type="text" name="email" value="'. $row['email'] .'">';
			   echo '<br>';
			   echo '<br> <strong>Qualification :</strong> '.'<input type="text" name="qualification" value="'. $row['qualification'] .'" onKeyPress="return ValidateAlpha(event)">'; 
			   echo '<br>';
