...
<body>
    <form action="searchempinfoaction.php" method="post" name="abc" onSubmit="return validateForm1()">
        <?php
        ...
        ?>
        <h4 class="d-flex justify-content-center">Search Employee Informatoin by ID<h4>
...
?></div>
            ...
            <div id="UILabel" align="center">
                <h3>Search Employee Informatoin by ID<h1>
                        <strong>Search:</strong> <input type="text" name="id" onKeyPress="return isNumberKey(event)" />
