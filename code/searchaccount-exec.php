...
$id = $_POST['id'];
if($id>0){
 if($result=mysqli_query($con,"SELECT * FROM Account where id='$id'")){
	...
	echo "please enter searching ID!";
	?>
            <tbody>
...
<!-- <body bgcolor="pink">
    ...
    <br /><br />
    <h1>
        <p align="center"><u> search account result</u></p>
    </h1>
<--?php	
// $con= mysqli_connect("localhost","root","");
// if (!$con)
...
// <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'><font color='white' size='1'>disable</th>
// </tr>";
// $numrows=mysqli_num_rows($result);
// if (($numrows == 0))
//                         {
