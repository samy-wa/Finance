...
<body>
    ...
    <form action="updateaccount.php" method="post" name="abc" onSubmit="return validateForm1()"><?php
...
<!-- <body bgcolor="white-green">
    ...
    <p style="text-align:justify; font-size:18px; color:#003366;">
        <script src="js/validateaccount.js" language="javascript" type="text/javascript"></script>
    <form action="updateaccount.php" method="post" name="abc" onSubmit="return validateForm1()">
