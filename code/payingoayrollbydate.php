...
<body>
    <form action="viewpayroll.php" method="post" name="abc" onSubmit="return validateForm1()"><?php
...
?>
        <h4 class="d-flex justify-content-center">View Payroll information by Date<h4>
...
<!-- <body bgcolor="blue-black">
    ...
    <p style="text-align:justify; font-size:18px; color:#003366;">
        <script src="js/validateaccount.js" language="javascript" type="text/javascript"></script>
    <form action="viewpayroll.php" method="post" name="abc" onSubmit="return validateForm1()">
...
?></div>
            ...
            <div id="UILabel" align="left">

                <h3>View Payroll information by Date<h3>
                        <strong>Search:</strong> <input type="date" name="dayfrom" id="dayfrom" /> &nbsp; TO
                        &nbsp;<input type="date" name="dayto" id="dayto" />
