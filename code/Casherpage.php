    ...
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    <h1 class="text-light"><a href="Casherpage.php"><span>FINANCE</span></a></h1>
                </div>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#HomeSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle"
                        aria-controls="HomeSubmenu">Payroll<i class="fas fa-caret-down"
                            style="margin-left:10px"></i></a>
                    <ul class="collapse list-unstyled" id="HomeSubmenu">
                        <li class="active">
                            <a class="display-iframe" data-display-iframe="true" href="payroll.php"
                                target="bayew">Payroll Form</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="payingoayrollbydate.php"
                                target="bayew">Paying information</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="updatepayrollbyid.php"
                                target="bayew">Update payroll</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="deletepayrollbyid.php"
                                target="bayew">Cancel expired payroll data</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="otherexpenditure.php"
                                target="bayew">Other Expenditures</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="cashmessage.php"
                                target="bayew">Write Message & comment</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="viewcashermessage.php"
    ...
    <body>
        <div id="content">
            ...
            <div id="header">
                ...
                <div id="menu">
                    <ul>
                        <li><a href="Casherpage.php">Home</a></li>
...
<!-- <div id="main_top">
                <div id="main">
                    ...
                    <div id="left">
                        ...
                        <div id="categories">
                            <ul>
                                <li><a href="payroll.php" target="bayew">Payroll Form</a></li>
                                <li><a href="payingoayrollbydate.php" target="bayew">Paying information</a></li>
                                <li><a href="updatepayrollbyid.php" target="bayew">Update payroll </a></li>
                                <li><a href="deletepayrollbyid.php" target="bayew">Cancel expired payroll data</a></li>
                                <li><a href="otherexpenditure.php" target="bayew">Other Expenditures</a></li>
                            </ul>
                        </div>
                        ...
                        <div id="partners">
                            <ul>
                                <li><a href="cashmessage.php" target="bayew">Write Message & commennt</a></li>
                                <li><a href="viewcashermessage.php" target="bayew">View Message Here</a></li>
                            </ul>
        ...
        <center>
            ...
            <div id="footer">
                <p>Copyright©2011 <a href="#">Privacy Policy</a>
                <p>Design by <a href="http://www.metamorphozis.com/" title="Free Web Templates">Samara university Cs
                        students</a>
                </p>
