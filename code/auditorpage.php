    ...
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    <h1 class="text-light"><a href="auditorpage.php"><span>FINANCE</span></a></h1>
                </div>
            </div>
            ...
            <ul class="list-unstyled components">
                <li>
                    <a href="#HomeSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle"
                        aria-controls="HomeSubmenu">Audit Types<i class="fas fa-caret-down"
                            style="margin-left:10px"></i></a>
                    <ul class="collapse list-unstyled" id="HomeSubmenu">
                        <li class="active">
                            <a class="display-iframe" data-display-iframe="true" href="auditbydate.php"
                                target="bayew">Payroll Auditing</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="auditexpansebydate.php"
                                target="bayew">Audit Other Expense</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="auditormessage.php"
                                target="bayew">Write Message & comment</a>
                        </li>
                        <li>
                            <a class="display-iframe" data-display-iframe="true" href="viewauditormessage.php"
