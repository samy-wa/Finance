...
<body>
    <form action="deletepayrollaction.php" method="post" name="abc" onSubmit="return validateForm1()">
        <?php
...
?>
        <h4 class="d-flex justify-content-center">search payroll by ID Then Delete <h4>
...
?></div>
            ...
            <div id="UILabel" align="center">
                <h3>search payroll by ID Then Delete<h1>
