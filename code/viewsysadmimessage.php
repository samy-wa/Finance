            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    <?php
						...
						//$too=$_POST["too"];
						$query="select * from message where too='systemadmin' ";
						...
						echo '<td>';
						 ?>
                    <a rel="facebook" href="sysadminmsg1.php?m_id=<?php echo $row3['m_id']; ?> & view=delete"
...
?>
            ...
            <head>
                <center color:#FFFFFF;>
                    <h3><u><strong style="background-color: #F0FFFF">New Message</strong></u></h1>
                </center>
                <form name="search" method="post" action="searchmsg2.php">
                    <br><br>
                    <table border="1" align="center" width="600">
                        ...
                        <tr>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>M_id
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>From
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>Too
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>Pnumber
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>Message
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>Date
                            </th>
                            <th style='height:50px;	color:#000;	font-weight:bold;background-color:#000;'>
                                <font color='white' size='1'>Action
                            </th>
                        </tr>

                        <--?php 
//$too=$_POST["too"];
$query="select * from message where too='systemadnin' ";
$result=mysqli_query($con,$query);
while($row3 = mysqli_fetch_array($result)) 
{
echo "<tr>";
